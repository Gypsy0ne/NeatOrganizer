...
/**
 * The configuration screen for the [TasksAppWidget] AppWidget.
 */
class TasksAppWidgetConfigureActivity : AppCompatActivity() {
    private val taskGroupsViewModel: TasksWidgetConfigurationViewModel by viewModel()


    private var appWidgetId = AppWidgetManager.INVALID_APPWIDGET_ID
    private var onClickListener = View.OnClickListener {
        val context = this@TasksAppWidgetConfigureActivity
...
//        saveTitlePref(context, appWidgetId, widgetText)
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        val binding = DataBindingUtil.setContentView<WidgetTasksConfigurationBinding>(
            this,
            R.layout.widget_tasks_configuration
        ).apply {
            groupsViewModel = taskGroupsViewModel
