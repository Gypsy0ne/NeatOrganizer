...
class ScheduledRoutineWithTasksTest : DatabaseTest() {
    ...
    fun shouldGetScheduledRoutineWithTasks() {
        // given
        val routineId = 1L
        val scheduledRoutine = one.gypsy.neatorganizer.database.entity.routines.RoutineEntity(
            "foobar",
            id = routineId,
            createdAt = 123124
        )
        val routineSchedule =
            one.gypsy.neatorganizer.database.entity.routines.RoutineScheduleEntity(
                monday = true,
                tuesday = true,
                wednesday = false,
                thursday = false,
    ...
    fun shouldMapToDomainModel() {
        ...
        val scheduledRoutineWithTasks =
            one.gypsy.neatorganizer.database.entity.routines.ScheduledRoutineWithTasks(
                scheduledRoutine,
                routineTasks,
                routineSchedule
            )
